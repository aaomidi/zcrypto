...
// Package x509 parses X.509-encoded certificate revocation lists.
package x509
...
func (rl *RevocationList) CheckSignatureFrom(parent *Certificate) error {
	...
	return parent.CheckSignature(SignatureAlgorithm(rl.SignatureAlgorithm), rl.RawTBSRevocationList, rl.Signature)
}
